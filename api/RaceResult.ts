// const info = {
//   name: '경주기록 정보',
//   url: 'https://www.data.go.kr/data/15058305/openapi.do',
//   key: 'meet-rcDate-rcNo-chulNo'
// }

export const RaceResultURL = '/B551015/API4_2/raceResult_2'

export interface RaceResultRequestParams {
	serviceKey: string
	pageNo?: number
	numOfRows?: number
	meet?: number
...
export const RaceResultKeyName: Record<string, string> = {
	age: '연령',
	ageCond: '연령조건',
